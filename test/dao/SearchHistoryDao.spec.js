...
describe('# searchHistoryDao Test', () => {
    before(async () => {       
        ...
        await Perfume.upsert({perfumeIdx: 1, brandIdx:1, mainSeriesIdx: 1, name: '오토니엘 로사 오 드 뚜왈렛', englishName: 'OTHONIEL ROSA EAU DE TOILETTE', imageThumbnailUrl:'', releaseDate: '2020-12-30'});
