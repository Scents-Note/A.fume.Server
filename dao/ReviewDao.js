...
module.exports.create = async ({
    ...
    const result = await pool.queryParam_Parse(SQL_REVIEW_INSERT, [
        perfumeIdx,
        userIdx,
        score,
        longevity,
...
module.exports.read = async (reviewIdx) => {
    const result = await pool.queryParam_Parse(SQL_REVIEW_SELECT_BY_IDX, [
        reviewIdx,
    ]);
    if (result.length == 0) {
...
module.exports.readAllByUser = async (userIdx) => {
    let result = await pool.queryParam_Parse(SQL_REVIEW_SELECT_BY_USER, [
        userIdx,
    ]);
...
module.exports.readAllOrderByLike = async (perfumeIdx) => {
    let result = await pool.queryParam_Parse(SQL_REVIEW_SELECT_ALL_BY_LIKE, [
        perfumeIdx,
    ]);
...
module.exports.readAllOrderByScore = async (perfumeIdx) => {
    let result = await pool.queryParam_Parse(SQL_REVIEW_SELECT_ALL_BY_SCORE, [
        perfumeIdx,
    ]);
...
module.exports.readAllOrderByRecent = async (perfumeIdx) => {
    let result = await pool.queryParam_Parse(SQL_REVIEW_SELECT_ALL_BY_RECENT, [
        perfumeIdx,
    ]);
...
module.exports.update = async ({
    ...
    const result = await pool.queryParam_Parse(SQL_REVIEW_UPDATE, [
        score,
        longevity,
        sillage,
        seasonal,
...
module.exports.createLike = async ({ userIdx, reviewIdx }) => {
    const result = await pool.queryParam_Parse(SQL_LIKE_REVIEW_INSERT, [
        userIdx,
        reviewIdx,
    ]);
    if (result.affectedRows == 0) {
...
module.exports.readLike = async ({ userIdx, reviewIdx }) => {
    const result = await pool.queryParam_Parse(SQL_LIKE_REVIEW_READ, [
        userIdx,
        reviewIdx,
    ]);
    if (result.length == 0) {
...
module.exports.deleteLike = async ({ userIdx, reviewIdx }) => {
    const result = await pool.queryParam_Parse(SQL_LIKE_REVIEW_DELETE, [
        userIdx,
        reviewIdx,
    ]);
    if (result.affectedRows == 0) {
